...
import (
	...
	"github.com/nholuongut/chart-testing/v3/pkg/config"
	"github.com/nholuongut/chart-testing/v3/pkg/exec"
	"github.com/nholuongut/chart-testing/v3/pkg/ignore"
	"github.com/nholuongut/chart-testing/v3/pkg/tool"
	"github.com/nholuongut/chart-testing/v3/pkg/util"
)
...
func (t *Testing) InstallChart(chart *Chart) TestResult {
	...
	if t.config.Upgrade {
		...
		// Test upgrade of current version (related: https://github.com/nholuongut/chart-testing/issues/19)
