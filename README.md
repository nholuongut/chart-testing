...
* [Yamllint](https://github.com/nholuongut/yamllint)
* [Yamale](https://github.com/nholuongut/yamale)
...
* [charts-repo-actions-demo](https://github.com/nholuongut/charts-repo-actions-demo)
...
Note that linting requires config file for [yamllint](https://github.com/nholuongut/yamllint) and [yamale](https://github.com/nholuongut/yamale).
...
Here's a previous one for reference: https://github.com/nholuongut/chart-testing/pull/89

### Create Release

The release workflow is [dispatched from github actions](https://github.com/nholuongut/chart-testing/actions)
...
This is because, while the [v2.0.0](https://github.com/nholuongut/chart-testing/releases/tag/v2.0.0) release has parity with `v1`, it was refactored from a bash library to Go so there are minor syntax differences.
Compare [v1 usage](https://github.com/nholuongut/chart-testing/tree/release-v1#usage) with this (`v2`) version's README [usage](#usage) section above.
